...
import { MultiFleetDashboard } from './pages/MultiFleetDashboard';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/fleets" element={<RequireAuth><MultiFleetDashboard /></RequireAuth>} />
      <Route path="/" element={<RequireAuth><PortalLayout /></RequireAuth>}>
        <Route index element={<Navigate to="/fleets" replace />} />
